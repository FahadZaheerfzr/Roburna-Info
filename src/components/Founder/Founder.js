...
export default function Founder() {
    return (
        <div className='flex flex-col items-center'>
            <span className='font-bold md:text-8xl xl:text-[118px] leading-none text-center'>
                Lars <br />
                Fabricius
            </span>

            <img className='my-28 rounded-full md:w-96 md:h-96 lg:w-[500px] lg:h-[500px] xl:w-[650px] xl:h-[650px]' src="/founder/lars.png" alt="founder" />


            <span className='font-normal md:text-xl lg:text-2xl xl:text-3xl text-center'>
